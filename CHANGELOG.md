...
All notable changes to nvim-key-insights are documented in this file. The
format follows [Keep a Changelog](https://keepachangelog.com/en/1.1.0/), and
package releases use [Semantic Versioning](https://semver.org/spec/v2.0.0.html).
Data-contract versions have their own compatibility lifecycle and are not
derived from package SemVer.
...
- Privacy-first Neovim collection with content-free Insert text runs,
  force-excluded special and sensitive buffers, bounded finalized-session
  retention, pause/resume, shutdown finalization, and explicit purge.
- Deterministic streaming Rust analysis, atomic summary/report publication,
  API-derived mapping attribution, guarded ergonomic evidence, and recovery
  checks.
