...
vim.bo.filetype = "lua"
vim.keymap.set("n", "z9", "<Cmd>let g:PUBLIC_MAPPING_RHS_SECRET = 1<CR>", { desc = "public E2E mapping" })
...
feed("iPUBLIC_UNICODE_雪_\\\"_SECRET<Esc>")
...
feed("ll")
feed("z9")
assert(vim.g.PUBLIC_MAPPING_RHS_SECRET == 1, "public mapping RHS canary did not execute")
