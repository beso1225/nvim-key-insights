...
preview and immediately around bounded mutation. The final notification reports
removed, protected, skipped, and failed counts. One unlink failure does not make
the engine broaden its selection.
