...
```sh
nix run 'github:beso1225/nvim-key-insights?ref=v0.2.3#key-insights' -- --version
nix profile install 'github:beso1225/nvim-key-insights?ref=v0.2.3#key-insights'
```
...
```sh
codex plugin marketplace add beso1225/nvim-key-insights@v0.2.3
codex plugin add nvim-key-insights@nvim-key-insights
```
