...
All current summaries use schema version 5. Snapshot-aware summaries contain
...
continues to accept schema-v1 logs and emits the same schema-v5 shape without
